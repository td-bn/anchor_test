...
pub mod program {
    ...
    pub struct AnchorTestPoc;
    #[automatically_derived]
    #[allow(unused_qualifications)]
    impl ::core::clone::Clone for AnchorTestPoc {
        #[inline]
        fn clone(&self) -> AnchorTestPoc {
            match *self {
                Self => AnchorTestPoc,
            }
        }
    }
    impl anchor_lang::Id for AnchorTestPoc {
        fn id() -> Pubkey {
            ID
        }
    }
...
mod __private {
    ...
    pub mod __global {
        ...
        pub fn initialize(
            ...
            let result = anchor_test_poc::initialize(anchor_lang::context::Context::new(
                program_id,
                &mut accounts,
                remaining_accounts,
                __bumps,
